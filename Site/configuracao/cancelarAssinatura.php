...
try {
    ...
    if ($usuario['tipoUsuario'] === 'Diretor' && !empty($usuario['codigoEscola'])) {
        ...
        // CORREÇÃO/GARANTIA AQUI: Limpa o codigoEscola, mesmo que já fosse NULL, e define o plano para Básico
        $sql_update_user = "UPDATE tb_usuario SET plano = 'Basico', codigoEscola = NULL, statusPlano ='pendente' WHERE id = ?";
        ...
        // ESTA LINHA JÁ ESTAVA DELETANDO A ASSINATURA INDIVIDUAL
