...
class PDF extends TCPDF {
    ...
    public function Header() {
        ...
        // Título principal
        $this->Cell(0, 15, 'Relatório de Desempenho por Matéria', 0, false, 'C', 0, '', 0, false, 'M', 'M');
...
$pdf->SetTitle('Relatório de Desempenho por Matéria - ' . $nomeEscolaExibicao);
...
$pdf->Write(0, 'Desempenho Agregado por Matéria', '', 0, 'L', true, 0, false, false, 0);
$pdf->Ln(2);
...
$filename = "Relatorio_Desempenho_Materia_" . ($codigoEscolaFiltrada ?: "Geral") . "_" . date("Ymd") . ".pdf";
