...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && (isset($_POST['vincular_aluno']) || isset($_POST['desvincular_aluno']))) {
    ...
    if (isset($_POST['vincular_aluno'])) {
        // Ação VINCULAR - Verificar se há vagas disponíveis
...
<head>
    ...
    <style>
        ...
        main {
            padding-top: 100px; /* Ajuste o padding para compensar a barra de navegação */
            padding-bottom: 30px;
        }
        .container {
        ...
        .btn-vincular {
            background-color: #1cc88a; /* Cor de sucesso mais clara */
            color: white;
        }
        .btn-vincular:hover {
