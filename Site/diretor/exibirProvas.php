...
$limiteSemanalProvas = $limitesProvas[$planoUsuario] ?? null; // Alterado para manter 'null' se não existir

// A verificação agora é mais direta: se o limite for nulo, a contagem não é feita.
// Apenas planos com limite definido (ex: 'basico') passarão por esta checagem.
...
<style>
    :root{
        ...
        /* Padding de espaçamento principal abaixo do menu.php */
        --content-padding-top: 100px; /* AUMENTADO PARA MAIS ESPAÇAMENTO NO TOPO */
    }
    * {box-sizing:border-box}
    ...
    /*
        AJUSTES PARA REMOVER FIXAÇÃO E ADICIONAR MARGENS (PADDING EXTERNO)
    */

    /* Toolbar: REMOVIDO POSITION: FIXED. Adicionado MARGIN para espaçamento. */
    .toolbar {
        /* Fixação removida */
        position: static;
        
        /* Espaçamento vertical acima e abaixo da barra de filtros. Usa a nova variável para o TOP. */
        margin-top: var(--content-padding-top); /* NOVO VALOR: 40px para afastar do menu superior */
        margin-bottom: 25px;
    ...
    /* Main: Ajusta o padding-top para um valor simples */
    .main {
        max-width: 1200px;
        margin: 0 auto 40px;
        padding: 0 20px;
        /* Padding no .main foi ajustado para 0, pois o .toolbar já gerencia o espaço superior */
        padding-top: 0; 
    }
    ...
    @media (max-width: 768px) {
        :root {
            --content-padding-top: 230px; /* Mais padding no mobile */
        }
        /* No mobile, o toolbar-inner fica mais compacto, mantendo o margin-top do toolbar */
        .toolbar {
            margin-top: var(--content-padding-top); /* 35px */
        }
        .main {
             padding-top: 0;
        }
    ...
    /* FIM DOS AJUSTES DE POSITION/PADDING */
...
<body>
    ...
    <script>
        ...
        // Limpar tudo (botões no empty state)
        $('#limparTudo1')?.addEventListener('click', ()=>{ setInstFilter('all'); });
        $('#limparTudo2')?.addEventListener('click', ()=>{ setInstFilter('all'); });
