...
$nomeProvaAlvo = "ID 85 - Simulado 2º Ano"; // Título ajustado 
...
// =========================================================================
// 4. CLASSE DE EXTENSÃO DO TCPDF (Configuração do PDF - REINTRODUZIDA)
// =========================================================================
...
class PDF extends TCPDF {
    ...
    public function Header() {
        ...
        // Título principal
        $this->Cell(0, 15, 'Relatório de Desempenho por Matéria - 2º Ano (ID85)', 0, false, 'C', 0, '', 0, false, 'M', 'M'); // Título ajustado
...
$pdf->SetTitle('Relatório de Desempenho por Matéria - ID85 - ' . $nomeEscolaExibicao); 
...
$pdf->Write(0, 'Desempenho Agregado por Matéria (Prova ID85)', '', 0, 'L', true, 0, false, false, 0); // Título ajustado
$pdf->Ln(2);
...
$filename = "Relatorio_Desempenho_Materia_ID85_" . ($codigoEscolaFiltrada ?: "Geral") . "_" . date("Ymd") . ".pdf";
