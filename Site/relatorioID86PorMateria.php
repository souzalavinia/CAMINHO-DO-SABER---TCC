...
$nomeProvaAlvo = 'ID86 - Desempenho por Matéria';
...
// =========================================================================
$pdf_url = 'relatorioID86PorMateria_pdf.php'; // ATUALIZADO PARA O NOVO NOME
...
<head>
    ...
    <title>Relatório de Desempenho ID86 - 1º Ano <?= $tituloExibicao ?></title> 
...
<body>
    ...
    <main>
        <div class="form-container">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                <h1><i class="fas fa-book-reader"></i> Desempenho Simulado 1° Ano por Matéria: <?= $tituloExibicao ?></h1>
            ...
            <form action="relatorioID86PorMateria.php" method="GET" class="filter-form">
                <div class="form-group" style="flex-direction: row; flex-wrap: wrap;"> 
                    ...
                    <div style="flex-grow: 1; min-width: 250px;">
                        ...
                        <p style="padding: 10px; border: 1px solid #ccc; border-radius: 5px; background-color: #eee; width: 100%;">ID86</p>
                    </div>
                ...
                <?php if (!empty($codigoEscolaFiltrada) || $tipoUsuarioSessao === 'diretor'): ?>
                    <p style="margin-top: 10px; font-weight: bold;">
                        ...
                        Escola: <?= htmlspecialchars($nomeEscolaFiltrada) ?> | Prova: ID86 (Por Matéria)
                    </p>
                <?php endif; ?>
            </form>
            <hr style="margin-top: 20px; border-color: #ccc;">
            
            <h2 style="margin-top: 30px; color: var(--primary-color);">Desempenho Agregado por Matéria (Prova ID86)</h2>
            
            <?php if (empty($relatorioAgregadoMateria)): ?>
                <p style="text-align: center; margin-top: 20px;">Nenhuma tentativa da Prova ID86 encontrada com os filtros aplicados.</p>
            <?php else: ?>
    ...
    <footer>
        <p>&copy; 2025 Caminho do Saber. Todos os direitos reservados. (Relatório ID86)</p>
