...
// Mapeamento de Prova e Área de Conhecimento (ID85) - 2º ANO
$mapaQuestoesID85 = [
...
$idProvaAlvo = 85; // ID da nova prova
$nomeProvaAlvo = 'ID85 - Desempenho por Matéria';
...
$sqlCaseMateria = "CASE ";
// ATENÇÃO: Usando $mapaQuestoesID85
foreach ($mapaQuestoesID85 as $questao => $materia) { 
    // Usando 'q.numQuestao'
...
// =========================================================================
$pdf_url = 'relatorioID85PorMateria_pdf.php'; // ATUALIZADO PARA O NOVO NOME
...
<head>
    ...
    <title>Relatório de Desempenho ID85 - 2º Ano <?= $tituloExibicao ?></title> 
...
<body>
    ...
    <main>
        <div class="form-container">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                <h1><i class="fas fa-book-reader"></i> Desempenho Simulado 2° Ano por Matéria: <?= $tituloExibicao ?></h1>
            ...
            <form action="relatorioID85PorMateria.php" method="GET" class="filter-form">
                <div class="form-group" style="flex-direction: row; flex-wrap: wrap;"> 
                    ...
                    <div style="flex-grow: 1; min-width: 250px;">
                        ...
                        <p style="padding: 10px; border: 1px solid #ccc; border-radius: 5px; background-color: #eee; width: 100%;">ID85</p>
                    </div>
                ...
                <?php if (!empty($codigoEscolaFiltrada) || $tipoUsuarioSessao === 'diretor'): ?>
                    <p style="margin-top: 10px; font-weight: bold;">
                        ...
                        Escola: <?= htmlspecialchars($nomeEscolaFiltrada) ?> | Prova: ID85 (Por Matéria)
                    </p>
                <?php endif; ?>
            </form>
            <hr style="margin-top: 20px; border-color: #ccc;">
            
            <h2 style="margin-top: 30px; color: var(--primary-color);">Desempenho Agregado por Matéria (Prova ID85)</h2>
            
            <?php if (empty($relatorioAgregadoMateria)): ?>
                <p style="text-align: center; margin-top: 20px;">Nenhuma tentativa da Prova ID85 encontrada com os filtros aplicados.</p>
            <?php else: ?>
    ...
    <footer>
        <p>&copy; 2025 Caminho do Saber. Todos os direitos reservados. (Relatório ID85)</p>
