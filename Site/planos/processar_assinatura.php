...
$query = "INSERT INTO tb_assinaturas (nomeUsuario, telefoneUsuario, emailUsuario, idUsuario, nomePlano, descricaoPlano) VALUES ('$nomeUsuario', '$telefoneUsuario', '$emailUsuario', '$idUsuario', '$nomePlano', '$descricaoPlano')";

if ($conn->query($query) === TRUE) {
    header("Location: ../configuracao/configuracoes.php");
} else {
