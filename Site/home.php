...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        main {
            flex: 1;
            padding-top: 100px; /* o menu.php também compensa, mas mantemos por segurança */
            padding-bottom: 20px;
        }

        /* ----- (REMOVIDO) Todo CSS do header/nav/user-menu antigo ----- */
        ...
        /* Cards - Melhoria para 3 colunas */
        .cards-container {
            /* Flexbox para centralizar e dispor os cards */
            display: flex;
        ...
        .card, .card3 {
            /* Define a largura para 3 cards por linha com espaço */
            width: calc(33.333% - 20px); /* 100% / 3 - um pouco menos para o gap */
        ...
        /* Se for manter o .card3, ajuste-o para se comportar como os outros cards */
        .card3 {
            width: calc(33.333% - 20px);
            min-width: 280px;
            max-width: none; /* Remove o max-width de 800px para alinhar com os outros */
            margin: 0; /* Remove a margem desnecessária, já existe o gap */
        }
        ...
        /* Responsivo - Ajuste para exibir 1 ou 2 cards em telas menores */
        @media screen and (max-width: 1050px) {
            .card, .card3 {
                /* Em telas médias, exibe 2 por linha */
                width: calc(50% - 15px);
            }
        }
        @media screen and (max-width: 768px) {
            .input-container { width: 80%; flex-direction: column; }
            .enviar { width: 80%; margin: 10px 0 0 0; }
            .card, .card3 {
                /* Em telas pequenas, exibe 1 por linha e usa 90% da largura */
                width: 90%;
                max-width: 480px; /* Adiciona um max-width para não esticar demais em telas pequenas/médias */
            }
        }
    ...
    <main>
        <div class="cards-container">
            <div class="card animate-in">
                <div class="header">
                    <span class="title2">Simulados</span>
                    <span class="price">ACESSAR</span>
                </div>
                <p class="desc">Acesse os simulados com os códigos de serial da prova.</p>
                <a href="simulado.php" class="action">Acessar</a>
            </div>
