...
.modal {
    ...
    z-index: 50; /* Z-index padrão */
    justify-content: center;
    align-items: center; /* Centralizado verticalmente em desktop */
    padding: 20px;
    padding-top: var(--header-h); /* Espaçamento no topo igual à altura do menu */
}
.m-content {
    background: #fff;
    max-width: 980px;
    ...
    box-shadow: var(--sh);
    position: relative;
    /* Adicionando um espaçamento interno superior para o conteúdo */
    padding-top: 10px;
}
	...
	/* Adicione um padding superior para dar mais espaço */
	padding-top: 20px;
}
...
.close {
    position: absolute;
    right: 14px;
    top: 14px; /* Posicionamento relativo ao m-content */
    border: none;
...
@media (max-width: 768px) {
    /* No mobile, o modal se alinha ao topo, mas mantém o espaçamento */
    .modal {
        align-items: flex-start;
        /* Garante que o modal comece a ser exibido abaixo do menu */
        padding-top: calc(var(--header-h) + 20px);
    }
    .m-content {
        /* Para telas menores, podemos diminuir a margem superior para o modal ficar mais alto */
        margin-top: 0;
        max-height: 90vh; /* Permite que o modal use mais altura da tela */
    }
    /* Opcional: Adicionar um z-index mais alto para o menu em mobile, se necessário */
    .site-header-spacer {
        z-index: 60;
    }
}
